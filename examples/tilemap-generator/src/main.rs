...
fn main() {
    ...
    let _ = write_tilemap_to_file("apps/tank-game/assets/map3.txt", &tilemap);
    let _ = write_tilemap_to_file("apps/tank-game/assets/map3_p1_units.txt", &tilemap);
    let _ = write_tilemap_to_file("apps/tank-game/assets/map3_p2_units.txt", &tilemap);
}
